![docker image](https://github.com/Sathya-S3/nomad-distro-template-test2-test2/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Sathya-S3/nomad-distro-template-test2-test2.git
    cd nomad-distro-template-test2
    ```

    or

    ```sh
    curl-L -o nomad-distro-template-test2.zip "https://github.com/Sathya-S3/nomad-distro-template-test2-test2/archive/main.zip"
    unzip nomad-distro-template-test2.zip
    cd nomad-distro-template-test2
    ```
...
your `docker-compose.yaml` with `ghcr.io/sathya-s3/nomad-distro-template-test2-test2:main` for the services
...
```sh
docker pull ghcr.io/sathya-s3/nomad-distro-template-test2-test2/jupyter:main
```
...
```sh
git remote add template https://github.com/FAIRmat-NFDI/nomad-distro-template-test2
git fetch template
...
For detailed instructions on how to resolve the merge conflicts between different version we refer you to the latest template release [notes](https://github.com/Sathya-S3/nomad-distro-template-test2-test2/releases/latest)
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Sathya-S3/nomad-distro-template-test2-test2/manifests/main": unauthorized`
